 ...
 */
class PitestUtils(private val projectConfiguration: ProjectConfiguration) {
    private val libFolder = "build/libs"

    /**
     * Extracts the mutation score from the PITest HTML report.
     *
     * @return The mutation score as an integer percentage.
     *         Returns 0 if the report file does not exist or the score cannot be extracted.
     */
    fun getMutationScore(): Int {
